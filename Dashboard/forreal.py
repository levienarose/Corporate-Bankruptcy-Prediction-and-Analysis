...
if uploaded_file is not None:
    ...
    fig.update_yaxes(title_text="Profit Rate", title_font=dict(color="#8B949E"), row=1, col=1)
    fig.update_yaxes(title_text="Debt Percentage", title_font=dict(color="#8B949E"), row=1, col=2)
    fig.update_yaxes(title_text="Cash Percentage", title_font=dict(color="#8B949E"), row=2, col=1)
    fig.update_yaxes(title_text="Sales Efficiency", title_font=dict(color="#8B949E"), row=2, col=2)
